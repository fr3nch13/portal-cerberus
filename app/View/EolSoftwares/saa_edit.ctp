...
?>
<div class="top">
	<h1><?php echo __('Edit %s', __('%s %s', __('EOL/US'), __('Software')) ); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create();?>
		    <fieldset>
		        <legend><?php echo __('Edit %s', __('%s %s', __('EOL/US'), __('Software')) ); ?></legend>
		    	<?php
		...
		<?php echo $this->Form->end(__('Update %s', __('%s %s', __('EOL/US'), __('Software')) )); ?>
	</div>
</div>