...
$page_options = array();
$block_options = array();
$page_options['org'] = $this->Html->link(__('By %s', __('ORG/IC')), array('action' => 'db_tab_remediation', 'org'), array('class' => 'tab-hijack'));
$block_options['org'] = $this->Html->link(__('By %s', __('ORG/IC')), array('action' => 'db_tab_remediation', 'org', 1), array('class' => 'block-hijack'));
$page_options['division'] = $this->Html->link(__('By %s', __('Division')), array('action' => 'db_tab_remediation', 'division'), array('class' => 'tab-hijack'));
$block_options['division'] = $this->Html->link(__('By %s', __('Division')), array('action' => 'db_tab_remediation', 'division', 1), array('class' => 'block-hijack'));
$page_options['branch'] = $this->Html->link(__('By %s', __('Branch')), array('action' => 'db_tab_remediation', 'branch'), array('class' => 'tab-hijack'));
$block_options['branch'] = $this->Html->link(__('By %s', __('Branch')), array('action' => 'db_tab_remediation', 'branch', 1), array('class' => 'block-hijack'));
$page_options['sac'] = $this->Html->link(__('By %s', __('SAC')), array('action' => 'db_tab_remediation', 'sac'), array('class' => 'tab-hijack'));
$block_options['sac'] = $this->Html->link(__('By %s', __('SAC')), array('action' => 'db_tab_remediation', 'sac', 1), array('class' => 'block-hijack'));
$page_options['owner'] = $this->Html->link(__('By %s', __('System Owner')), array('action' => 'db_tab_remediation', 'owner'), array('class' => 'tab-hijack'));
$block_options['owner'] = $this->Html->link(__('By %s', __('System Owner')), array('action' => 'db_tab_remediation', 'owner', 1), array('class' => 'block-hijack'));
$page_options['system'] = $this->Html->link(__('By %s', __('FISMA System')), array('action' => 'db_tab_remediation', 'system'), array('class' => 'tab-hijack'));
$block_options['system'] = $this->Html->link(__('By %s', __('FISMA System')), array('action' => 'db_tab_remediation', 'system', 1), array('class' => 'block-hijack'));
...
{
	$th['ReportsRemediation.'.$reportsRemediation_id] = array('content' => $reportsRemediation_name);
}
...
foreach($results as $resultId => $result)
{
	...
	foreach($reportsRemediations as $reportsRemediation_id => $reportsRemediation_name)
	{
		...
		{
			if($high_riskResult['HighRiskResult']['reports_remediation_id'] == $reportsRemediation_id)
			{
		...
		if($td[$resultId]['ReportsRemediation.'.$reportsRemediation_id])
			$td[$resultId]['ReportsRemediation.'.$reportsRemediation_id] = array(
				$td[$resultId]['ReportsRemediation.'.$reportsRemediation_id],
...
if($as_block)
{
	...
	echo $this->element('Utilities.object_dashboard_block', array(
		'title' => __('%s - %s grouped by %s', __('High Risk'), __('Remediations'), $scopeName),
