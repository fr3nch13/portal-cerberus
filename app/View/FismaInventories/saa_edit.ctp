<?php ?>
<!-- File: app/View/FismaInventories/saa_edit.ctp -->
<div class="top">
	<h1><?php echo __('Edit %s', __('FISMA Inventory')); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('FismaInventory');?>
		    <fieldset>
		        <legend><?php echo __('Edit %s', __('FISMA Inventory')); ?></legend>
		    	<?php
...
*/
		...
		<?php echo $this->Form->end(__('Update %s', __('FISMA Inventory'))); ?>
	</div>
</div>
