<?php ?>
<!-- File: app/View/Pog/add.ctp -->
<div class="top">
	<h1><?php echo __('Add %s', __('Port Object Group')); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('Pog');?>
		    <fieldset>
		        <legend><?php echo __('Add %s', __('Port Object Group')); ?></legend>
		    	<?php
					...
					echo $this->Form->input('Pog.ports', array(
						...
						'between' => $this->Html->tag('p', __('Separate ports with a new line, or a comma (can include a range like 50-60).')),
					));
