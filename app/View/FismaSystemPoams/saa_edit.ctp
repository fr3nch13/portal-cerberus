<?php 
// File: app/View/FismaSystemPoams/saa_edit.ctp
?>
<div class="top">
	<h1><?php echo __('Edit %s', __('%s %s', __('FISMA System'), __('POAM'))); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('FismaSystemPoam');?>
			<fieldset>
				<legend><?php echo __('Edit %s', __('%s %s', __('FISMA System'), __('POAM'))); ?></legend>
				<?php
		...
		<?php echo $this->Form->end(__('Update %s', __('%s %s', __('FISMA System'), __('POAM')))); ?>
	</div>
</div>