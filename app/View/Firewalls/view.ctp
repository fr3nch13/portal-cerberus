...
//	$this->Form->postLink(__('Delete'),array('action' => 'delete', $firewall['Firewall']['id']),array('confirm' => 'Are you sure?')),
	$this->Html->link(__('Export ASA Ruleset (Bare)'), array('action' => 'view', $firewall['Firewall']['id'], 'ext' => 'txt')),
	$this->Html->link(__('Export ASA Ruleset'), array('action' => 'view', $firewall['Firewall']['id'], 'comments' => 1, 'ext' => 'txt')),
);
...
$tabs = array(
	array(
		'key' => 'rules',
		'title' => __('Rules'),
		'url' => array('controller' => 'rules', 'action' => 'firewall', $firewall['Firewall']['id']),
	),
);
