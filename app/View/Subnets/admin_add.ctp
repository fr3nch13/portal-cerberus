<?php 
// File: app/View/Subnet/admin_add.ctp
?>
<div class="top">
	<h1><?php echo __('Add %s', __('Subnet') ); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('Subnet');?>
		    <fieldset>
		        <legend><?php echo __('Add %s', __('Subnet') ); ?></legend>
		    	<?php
		...
		<?php echo $this->Form->end(__('Save %s', __('Subnet') )); ?>
	</div>
</div>
