...
$page_options = [];
$block_options = [];
$page_options['org'] = $this->Html->link(__('By %s', __('ORG/IC')), ['action' => 'db_tab_assignable_party', 'org'], ['class' => 'tab-hijack']);
$block_options['org'] = $this->Html->link(__('By %s', __('ORG/IC')), ['action' => 'db_tab_assignable_party', 'org', 1], ['class' => 'block-hijack']);
$page_options['division'] = $this->Html->link(__('By %s', __('Division')), ['action' => 'db_tab_assignable_party', 'division'], ['class' => 'tab-hijack']);
$block_options['division'] = $this->Html->link(__('By %s', __('Division')), ['action' => 'db_tab_assignable_party', 'division', 1], ['class' => 'block-hijack']);
$page_options['branch'] = $this->Html->link(__('By %s', __('Branch')), ['action' => 'db_tab_assignable_party', 'branch'], ['class' => 'tab-hijack']);
$block_options['branch'] = $this->Html->link(__('By %s', __('Branch')), ['action' => 'db_tab_assignable_party', 'branch', 1], ['class' => 'block-hijack']);
$page_options['sac'] = $this->Html->link(__('By %s', __('SAC')), ['action' => 'db_tab_assignable_party', 'sac'], ['class' => 'tab-hijack']);
$block_options['sac'] = $this->Html->link(__('By %s', __('SAC')), ['action' => 'db_tab_assignable_party', 'sac', 1], ['class' => 'block-hijack']);
$page_options['owner'] = $this->Html->link(__('By %s', __('System Owner')), ['action' => 'db_tab_assignable_party', 'owner'], ['class' => 'tab-hijack']);
$block_options['owner'] = $this->Html->link(__('By %s', __('System Owner')), ['action' => 'db_tab_assignable_party', 'owner', 1], ['class' => 'block-hijack']);
$page_options['system'] = $this->Html->link(__('By %s', __('FISMA System')), ['action' => 'db_tab_assignable_party', 'system'], ['class' => 'tab-hijack']);
$block_options['system'] = $this->Html->link(__('By %s', __('FISMA System')), ['action' => 'db_tab_assignable_party', 'system', 1], ['class' => 'block-hijack']);
...
{
	$th['ReportsAssignableParty.'.$reportsAssignableParty_id] = ['content' => $reportsAssignableParty_name];
}
...
foreach($results as $resultId => $result)
{
	...
	foreach($reportsAssignableParties as $reportsAssignableParty_id => $reportsAssignableParty_name)
	{
		...
		{
			if($fovResult['FovResult']['reports_assignable_party_id'] == $reportsAssignableParty_id)
			{
...
if($as_block)
{
	...
	echo $this->element('Utilities.object_dashboard_block', [
		'title' => __('%s - %s grouped by %s', __('FOV'), __('Assignable Parties'), $scopeName),
