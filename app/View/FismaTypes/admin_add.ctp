<?php 
// File: app/View/FismaType/admin_add.ctp
?>
<div class="top">
	<h1><?php echo __('Add %s', __('FISMA Type')); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('FismaType');?>
		    <fieldset>
		        <legend><?php echo __('Add %s', __('FISMA Type')); ?></legend>
		    	<?php
		...
		<?php echo $this->Form->end(__('Save %s', __('FISMA Type'))); ?>
	</div>
</div>