<?php 
// File: app/View/FismaType/admin_edit.ctp
?>
<div class="top">
	<h1><?php echo __('Edit %s', __('FISMA Type')); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('FismaType');?>
		    <fieldset>
		        <legend><?php echo __('Edit %s', __('FISMA Type')); ?></legend>
		    	<?php
		...
		<?php echo $this->Form->end(__('Update %s', __('FISMA Type'))); ?>
	</div>
</div>