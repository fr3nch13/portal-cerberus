<?php 
// File: app/View/FismaStatus/admin_edit.ctp
?>
<div class="top">
	<h1><?php echo __('Edit %s', __('FISMA Status')); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('FismaStatus');?>
		    <fieldset>
		        <legend><?php echo __('Edit %s', __('FISMA Status')); ?></legend>
		    	<?php
		...
		<?php echo $this->Form->end(__('Update %s', __('FISMA Status'))); ?>
	</div>
</div>