<?php 
// File: app/View/FismaStatus/admin_add.ctp
?>
<div class="top">
	<h1><?php echo __('Add %s', __('FISMA Status')); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('FismaStatus');?>
		    <fieldset>
		        <legend><?php echo __('Add %s', __('FISMA Status')); ?></legend>
		    	<?php
		...
		<?php echo $this->Form->end(__('Save %s', __('FISMA Status'))); ?>
	</div>
</div>