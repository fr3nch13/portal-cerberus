...
?>
<div class="top">
	<h1><?php echo __('Send Email Notification for %s: %s', __('Rule'), $this->data['Rule']['id']); ?></h1>
	...
	<div class="form">
		<?php echo $this->Form->create('Rule');?>
		    <fieldset>
		        ...
		        <?php
					echo $this->Form->input('Rule.id', array('type' => 'hidden'));
		...
		<?php echo $this->Form->end(__('Send Email Notification for %s', __('Rule'))); ?>
	</div>
</div>