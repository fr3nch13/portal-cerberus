...
?>
<div class="top">
	<h1><?php echo __('Edit %s', __('Rule')); ?></h1>
...
<div class="center">
	<div class="form">
		    ...
		    <fieldset>
		        ...
		        <?php
					...
					echo $this->Form->input('Rule.fw_int_id', array(
						...
						'div' => array('class' => 'half', 'id' => 'RuleSrcFwIntIdDiv'),
						'options' => $fw_ints,
						'after' => $this->Html->tag('div', $this->Html->link(__('Click to use Firewall and Interface'), '#', array('id' => 'UseRuleFirewallInt'))),
					));
					...
					echo $this->Form->input('Rule.firewall_id', array(
						...
						'div' => array('class' => 'forth FirewallIntDiv'),
						'class' => 'FirewallInt',
						'after' => $this->Html->tag('div', $this->Html->link(__('Click to use Firewall Path'), '#', array('id' => 'UseRuleFwInt'))),
					));
					
					echo $this->Form->input('Rule.fw_interface_id', array(
						'label' => array(
							'text' => __('Interface'),
						),
						'div' => array('class' => 'forth FirewallIntDiv'),
					...
					echo $this->Form->input('use_fw_int', array('type' => 'hidden'));
				...
				<?php
					...
					echo $this->Form->input('Rule.src_fog_id', array(
						...
						'options' => $fogs,
						'after' => $this->Html->tag('div', $this->Html->link(__('Click to use Ip Address(es)'), '#', array('id' => 'UseRuleSrcIpId'))),
					));
				...
				<?php
					...
					echo $this->Form->input('Rule.dst_fog_id', array(
						...
						'options' => $fogs,
						'after' => $this->Html->tag('div', $this->Html->link(__('Use Custom Ip Address(es)'), '#', array('id' => 'UseRuleDstIpId'))),
					));
					echo $this->Form->input('Rule.dst_ip', array(
						...
						'after' => $this->Html->tag('div', $this->Html->link(__('Use %s', __('Firewall Object Group')), '#', array('id' => 'UseRuleDstFogId'))),
					));
					...
					echo $this->Form->input('Rule.dst_pog_id', array(
						...
						'options' => $pogs,
						'after' => $this->Html->tag('div', $this->Html->link(__('Use Port(s)'), '#', array('id' => 'UseRuleDstPortId'))),
					));
					echo $this->Form->input('Rule.dst_port', array(
						...
						'after' => $this->Html->tag('div', $this->Html->link(__('Use %s', __('Port Object Group')), '#', array('id' => 'UseRuleDstPogId'))),
					));
		...
		<?php echo $this->Form->end(__('Update %s', __('Rule'))); ?>
	</div>
</div>
<?php 
...
$(document).ready(function()
{
	...
	// Firewall/Interface VS Firewall Path
	$('body').foFieldSwitcher({
		// These are the defaults.
		DefaultShow: 		'<?php echo $src_fw_int_show; ?>',
		HiddenSwitchId:		'#RuleUseFwInt',
		AInput: { FieldID: '#RuleSrcFwIntId', FieldDiv: '#RuleSrcFwIntIdDiv', FieldSwitcher: '#UseRuleFirewallInt', HiddenSwitchValue: 1 },
		BInput: { FieldID: 'input.FirewallInt', FieldDiv: 'div.FirewallIntDiv', FieldSwitcher: '#UseRuleFwInt', HiddenSwitchValue: 0 },
	});
