<?php 
// File: app/View/Rules/json/fisma_system.ctp
...
foreach ($rules as $i => $rule)
{
    ...
    $data[] = array(
		...
		'ReviewState.uri' => $this->Html->url(array('controller' => 'rules', 'action' => 'review_state', $rule['ReviewState']['id'])),
...
echo $this->Exporter->view($data, array('count' => count($data), 'fisma_system' => $fisma_system), $this->request->params['ext'], Inflector::camelize(Inflector::singularize($this->request->params['controller'])));
