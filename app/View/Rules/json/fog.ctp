<?php 
// File: app/View/Rules/json/fog.ctp
...
echo $this->Exporter->view($data, array('count' => count($data), 'fog' => $fog), $this->request->params['ext'], Inflector::camelize(Inflector::singularize($this->request->params['controller'])));
