<?php 
// File: app/View/Rules/json/firewall.ctp
...
echo $this->Exporter->view($data, array('count' => count($data), 'firewall' => $firewall), $this->request->params['ext'], Inflector::camelize(Inflector::singularize($this->request->params['controller'])));
