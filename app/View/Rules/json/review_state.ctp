<?php 
// File: app/View/Rules/json/review_state.ctp
...
echo $this->Exporter->view($data, array('count' => count($data), 'review_state' => $review_state), $this->request->params['ext'], Inflector::camelize(Inflector::singularize($this->request->params['controller'])));
