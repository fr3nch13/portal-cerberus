<?php 
// File: app/View/Rules/csv/pog.ctp
...
echo $this->Exporter->view($data, array('count' => count($data), 'protocol' => $protocol), $this->request->params['ext'], Inflector::camelize(Inflector::singularize($this->request->params['controller'])));
