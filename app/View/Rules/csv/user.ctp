<?php 
// File: app/View/Rules/csv/user.ctp
...
echo $this->Exporter->view($data, array('count' => count($data), 'user' => $user), $this->request->params['ext'], Inflector::camelize(Inflector::singularize($this->request->params['controller'])));
