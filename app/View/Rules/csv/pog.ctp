...
echo $this->Exporter->view($data, array('count' => count($data), 'pog' => $pog), $this->request->params['ext'], Inflector::camelize(Inflector::singularize($this->request->params['controller'])));
