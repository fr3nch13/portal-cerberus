<?php ?>
<!-- File: app/View/FismaSystem/saa_edit.ctp -->
<div class="top">
	<h1><?php echo __('Edit %s', __('FISMA System')); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('FismaSystem');  echo $this->Form->input('id'); ?>
			<fieldset>
			...
			<fieldset>
		    	...
		    	<?php
					...
					echo $this->Form->input('fisma_system_affected_party_id', array(
						'label' => array(
			...
			<fieldset>
		    	...
		    	<?php
					echo $this->Form->input('FismaSystem.FismaSoftware', array(
						'multiple' => true,
						'searchable' => true,
						'label' => __('Select which %s is/are associated with this %s', __('Whitelisted Software'), __('FISMA System')),
					));
				?>
			</fieldset>
			<fieldset>
		...
		<?php echo $this->Form->end(__('Update %s', __('FISMA System'))); ?>
	</div>
</div>