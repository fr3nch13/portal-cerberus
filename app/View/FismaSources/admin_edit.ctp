<?php 
// File: app/View/FismaSource/admin_edit.ctp
?>
<div class="top">
	<h1><?php echo __('Edit %s', __('FISMA Source')); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('FismaSource');?>
		    <fieldset>
		        <legend><?php echo __('Edit %s', __('FISMA Source')); ?></legend>
		    	<?php
		...
		<?php echo $this->Form->end(__('Update %s', __('FISMA Source'))); ?>
	</div>
</div>