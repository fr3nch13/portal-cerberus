<?php 
// File: app/View/FismaSource/admin_add.ctp
?>
<div class="top">
	<h1><?php echo __('Add %s', __('FISMA Source')); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('FismaSource');?>
		    <fieldset>
		        <legend><?php echo __('Add %s', __('FISMA Source')); ?></legend>
		    	<?php
		...
		<?php echo $this->Form->end(__('Save %s', __('FISMA Source'))); ?>
	</div>
</div>