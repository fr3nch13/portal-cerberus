...
// handles parsing of RTF files
CakePlugin::load('Cacher', array('bootstrap' => true));

// Manages the contact information for known org users
CakePlugin::load('Contacts', array('bootstrap' => true));

// Creates a batch import wizard
CakePlugin::load('Batcher');

// handles reading and writing of Excel spreadsheets
